...
class PlusExpandedBottomNavigationBar extends StatefulWidget {
  ...
  PlusExpandedBottomNavigationBar({
    Key key,
    @required this.items,
    this.onTap,
    this.currentIndex = 0,
...
class _PlusExpandedBottomNavigationBarState extends State<PlusExpandedBottomNavigationBar> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(PlusExpandedBottomNavigationBar oldWidget) {
...
class _Circle {
  ...
  final _PlusExpandedBottomNavigationBarState state;
  final int index;
  final Color color;
